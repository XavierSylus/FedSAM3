...
DEFAULT_CONFIG = Path(__file__).resolve().with_name("groupa_existing_outputs_figure_config.json")
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Generate Group A paper figures from existing AutoDL outputs without running inference."
    )
